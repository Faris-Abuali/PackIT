...
public class PackingList : AggregateRoot<PackingListId>
{
    ...
    {
        _items = items;
        // Make this constructor private to ensure it's safe (no duplicates) when `items` is assigned:
    }
    ...
    public void PackItem(string itemName)
    {
        ...
        // I can create a copy of the record with changed property using `with`
